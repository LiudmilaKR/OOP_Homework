package HomeworksAdd.HWOOPadd.HWLesson6oopAdd.view;

import java.util.Scanner;

import HomeworksAdd.HWOOPadd.HWLesson6oopAdd.model.Person;
import HomeworksAdd.HWOOPadd.HWLesson6oopAdd.presenter.Presenter;
...
public class ConsoleView implements View {
    ...
    public void start() {
        ...
        presenter = new Presenter(this, "HomeworksAdd/HWOOPadd/HWLesson6oopAdd/model/Tree.out");
        work = true;
        int point = 0;
        while (work) {
            System.out.println("Выбрите действие:\n1.Инициация первоначального дерева.\n" + 
