...
import HomeworksAdd.HWOOPadd.HWLesson7oopAdd.model.Person;
import HomeworksAdd.HWOOPadd.HWLesson7oopAdd.presenter.Presenter;
...
public class ConsoleView implements View {
    ...
    public void start() {
        ...
        presenter = new Presenter(this, "HomeworksAdd/HWOOPadd/HWLesson7oopAdd/model/Tree.out");
        Menu menu = new Menu();
        work = true;
        int point = 0;
        while (work) {
